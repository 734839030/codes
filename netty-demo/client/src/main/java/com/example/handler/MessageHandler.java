...
public interface MessageHandler {
     ...
     * @param msg
     */
    default void send(Channel channel, Object msg) {
        this.send(channel, msg, false, 0);
    }

    default void send(Channel channel, Object msg, int timeout) {
        this.send(channel, msg, true, timeout);
    }

    default void send(Channel channel, Object msg, boolean sync, int timeout) {
